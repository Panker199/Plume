...
## Plume Code Agent - models.dev Integration

### Overview
Plume Code Agent uses models.dev catalog for dynamic model discovery. Only FREE models are supported.
...
All models with cost.input = 0 AND cost.output = 0:
...
- **Coding**: Models with tool_call = true, large context
- **Analysis**: Models with reasoning = true
- **Fast**: Models with smaller context (faster responses)
- **Chat**: Models with largest context

...
import { Feather, Mail, Lock, User, ArrowRight, Eye, EyeOff } from 'lucide-react'
import './Auth.css'
    ...
    <div className="auth-page">
      <div className="auth-card">
        <div className="auth-brand">
          <div className="auth-logo"><Feather size={24} /></div>
          <span className="auth-brand-name">Plume</span>
        </div>

        <h1 className="auth-title">{mode === 'login' ? 'Welcome back' : 'Create account'}</h1>
        <p className="auth-sub">
          {mode === 'login'
            ? 'Sign in to continue to Plume'
            : 'Sign up to get started with Plume'}
        </p>
        ...
        <button type="button" className="demo-btn" onClick={() => onLogin('Guest')}>
          Try Demo
        </button>
      </div>
    </div>
